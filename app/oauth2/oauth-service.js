System.register(['js-base64', "sha256", 'base64-js'], function(exports_1) {
    var js_base64_1, sha256_1, base64_js_1;
    var OAuthService;
    return {
        setters:[
            function (js_base64_1_1) {
                js_base64_1 = js_base64_1_1;
            },
            function (sha256_1_1) {
                sha256_1 = sha256_1_1;
            },
            function (base64_js_1_1) {
                base64_js_1 = base64_js_1_1;
            }],
        execute: function() {
            OAuthService = (function () {
                ...
                OAuthService.prototype.checkAtHash = function (accessToken, idClaims) {
                    if (!accessToken || !idClaims || !idClaims.at_hash)
                        return true;
                    var tokenHash = sha256_1.default(accessToken, { asBytes: true });
