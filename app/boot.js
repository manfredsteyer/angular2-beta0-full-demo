System.register(['angular2/platform/browser', 'angular2/core', './services/flug-service', './registry', 'angular2/http', 'angular2/router', './services/flug-event-service', './app', 'rxjs/Observable', 'rxjs/add/operator/publish', 'rxjs/add/operator/share', 'rxjs/add/operator/catch', 'rxjs/add/operator/subscribeOn', 'rxjs/add/observable/from', 'rxjs/add/operator/map', './pipes/ort-pipe', './date-control/date-control', './oauth2/oauth-service', './services/configuration'], function(exports_1) {
    var browser_1, core_1, flug_service_1, registry_1, http_1, http_2, router_1, router_2, flug_event_service_1, app_1, Observable_1, ort_pipe_1, date_control_1, core_2, oauth_service_1, configuration_1;
    var options, services, o;
    return {
        setters:[
        ...
        execute: function() {
            options = new http_2.BaseRequestOptions();
            ...
            */
            o = Observable_1.Observable.create(function (observer) {
                setTimeout(function () {
                    observer.next(42);
                    observer.error("err!");
                }, 0);
